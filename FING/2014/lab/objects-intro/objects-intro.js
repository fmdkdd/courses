...
// Since its a singleton, there no "instances", just aliasing of the
// same object.
c1 === c2; //:
...
// *prototype* object.  Not that now the methods need to refer to `i`
// using the special value `this`, since we do not know the instance
// when defining these methods.  **Complete** the definition and check
// the tests.
...
// defined in one place, the prototype in another.  Is there an other
// way?
