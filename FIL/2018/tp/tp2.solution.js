...
function counterPrototypeFactory() {
  let obj = Object.create(counterPrototype);
  obj.i = 0;
  return obj;
}
...
let counterLiteral = {
  new() {
    let obj = Object.create(counterLiteral);
    obj.i = 0;
    return obj;
  },
...
function resetCounterPrototypeFactory() {
  let obj = Object.create(resetCounterPrototype);
  obj.i = 0;
  obj.resetCount = 0;
  return obj;
}
...
class ResetCounterClass extends CounterClass {
  constructor() {
    super()
    this.resetCount = 0;
  }
